      ...
      <div className="container mx-auto px-8">
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="p-8 text-center">
                {feature.icon}
                <h3
                  className={`text-2xl font-semibold mb-4 ${feature.textColor}`}
                >
                  {feature.title}
                </h3>
                <p className={`text-base ${feature.textColor}`}>
                  {feature.description}
                </p>
              </div>
            </a>
        ...
        <div className="border-t border-gray-300 mt-16 py-12 text-center">
          <blockquote className="text-xl italic text-gray-800 mx-auto max-w-2xl">
            &quot;Our platform empowers you to showcase your work and connect
