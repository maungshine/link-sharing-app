      ...
      <nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-4 shadow-md z-50">
        <div className="max-w-screen-xl mx-auto px-8 flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <Link
              href="/register"
              className="mx-2 text-lg bg-yellow-400 text-indigo-600 font-semibold py-2 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:bg-yellow-500 hover:scale-105"
            >
              Sign Up
            </Link>
          </div>
